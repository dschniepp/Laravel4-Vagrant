...
Vagrant.configure("2") do |config|
    config.vm.define :laravel4 do |lv4_config|
        ...
        lv4_config.vm.network :forwarded_port, guest: 8080, host: 8889, auto_correct: true
        ...
        lv4_config.vm.provision :shell, :inline => "echo \"Europe/Berlin\" | sudo tee /etc/timezone && dpkg-reconfigure --frontend noninteractive tzdata"
